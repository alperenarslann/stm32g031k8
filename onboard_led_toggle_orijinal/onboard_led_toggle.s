...
main:
	...
	movs r4,  0b00001100 //çaycı bit yerine 0x7 yazıyo aynı şey ama daha karışık gerek yk
...
/*hadi şimdi de PC7 ye output diyelim bakalım olcak mı*/
	...
	/*set 1, delay, set 2, delay*/
	/* for(;;); */
	ldr r1, =#9990000  /*yaklasık 1 sn delay */
	bl delay //bl means branch delay, when delay is over, continue from the line below bl->branch and link
	...
	b loop //sonsuza kadar döner bu böyle kendi içine branch attığı için
